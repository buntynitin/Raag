                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          width: 180,
                          height: 180,
                          child: Hero(    tag:'artist'+data.id.toString(),
...
class _FavouriteButtonState extends State<FavouriteButton> {
  List<int> favartistid = [];
  void initState() {
    super.initState();
    this.getJSONFavartistList();
  }

  Future<String> getJSONFavartistList() async {
    ...
    var url = 'https://raagmusic.herokuapp.com/favartistid?name=' + list[0]['username'];
      ...
      if (response.body != '[]') {
        ...
        setState(() {
          for (int i = 0; i < jsonResponse[0]['favouriteartist'].length; i++) {
            favartistid.add(jsonResponse[0]['favouriteartist'][i]);
          }
        });
      }
      }
  ...
  // favouriteartisthandler(bool isfavourite, int id, context) async {
  //   Directory documentsDirectory = await getApplicationDocumentsDirectory();
  //   String path = join(documentsDirectory.path, "User.db");
  //   var database = await openDatabase(
  //     path,
  ...
  //   List<Map> list = await database.rawQuery('SELECT * FROM userTable');
  //   if (isfavourite) {
  //     var url = 'https://raagmusic.herokuapp.com/removefavouriteartist/' +
  //         list[0]['username'] +
  //         '/' +
  //         id.toString();
  //     var response = await http.get(url);
  ...
  //     }
  //   } else {
  //     var url = 'https://raagmusic.herokuapp.com/addfavouriteartist/' +
  //         list[0]['username'] +
  //         '/' +
  //         id.toString();
  //     var response = await http.get(url);
  ...
  // }
     ...
     bool isfavourite = favartistid.contains(widget.data.id);
    ...
    List<Map> list = await database.rawQuery('SELECT * FROM userTable');
      ...
      var url = isfavourite?'https://raagmusic.herokuapp.com/removefavouriteartist/' +
          list[0]['username'] +
          '/' +
          id.toString():
          'https://raagmusic.herokuapp.com/addfavouriteartist/' +
          list[0]['username'] +
          '/' +
          id.toString();
  ...
  Widget build(BuildContext context) {
    return LikeButton(
      isLiked: favartistid.contains(widget.data.id),
    ...
    // IconButton(
    //                 icon: favartistid.contains(widget.data.id)
    //                     ? Icon(
    //                         Icons.favorite,
    //                         color: Colors.red,
    //                       )
    ...
    //                       ),
    //                 onPressed: () {
    //                   favouriteartisthandler(
    //                       favartistid.contains(widget.data.id),
    //                       widget.data.id,
    //                       context);
    //                 },
    //                 color: Colors.black,
